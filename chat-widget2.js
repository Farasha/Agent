...
(function() {
    ...
    // Default configuration with French translations
    const defaultConfig = {
        webhook: {
            url: '',
            route: ''
        ...
        branding: {
            logo: '',
            name: '',
            welcomeText: 'Salut 👋, comment pouvons-nous aider ?', // French translation
            responseTimeText: 'Nous répondons généralement tout de suite', // French translation
            poweredBy: {
                text: 'Powered by n8n',
    ...
    const newConversationHTML = `
        ...
        <div class="new-conversation">
            ...
            <button class="new-chat-btn">
                ...
                Envoyez-nous un message <!-- French translation -->
            </button>
    ...
    const chatInterfaceHTML = `
        <div class="chat-interface">
            ...
            <div class="chat-input">
                <textarea placeholder="Tapez votre message ici..." rows="1"></textarea> <!-- French translation -->
                <button type="submit">Envoyer</button> <!-- French translation -->
            </div>
        </div>
    `;
